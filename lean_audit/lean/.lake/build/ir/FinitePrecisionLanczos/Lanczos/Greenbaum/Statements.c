...
// Module: FinitePrecisionLanczos.Lanczos.Greenbaum.Statements
...
LEAN_EXPORT lean_object* initialize_FinitePrecisionLanczos_FinitePrecisionLanczos_Lanczos_Greenbaum_Statements(uint8_t builtin) {
lean_object * res;
